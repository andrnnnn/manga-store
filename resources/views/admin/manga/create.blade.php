...
<head>
    ...
    <title>Tambah Manga - {{ config('app.name') }}</title>
...
<body class="bg-gray-900 min-h-screen font-[Poppins] text-gray-100">
            ...
            <form id="mangaForm" action="{{ route('admin.manga.create') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="description" rows="4"
                            class="w-full px-4 py-2 rounded-lg bg-gray-700 border-gray-600 text-gray-100 focus:border-primary focus:ring-primary">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-2 text-sm text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="w-32 h-44 bg-gray-700/50 rounded-lg overflow-hidden">
                                <img id="coverPreview" src="{{ asset('images/default-cover.jpg') }}"
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            ...
                            <div class="mt-3 p-4 bg-gray-700/50 rounded-lg min-h-[100px]">
                                <div id="selectedCategories" class="flex flex-wrap gap-2"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-end">
                    <button type="button"
                        ...
                        <span class="btn-text">Simpan Manga</span>
                    </button>
                </div>
            </form>
        </div>
    ...
    <div id="confirmationModal" class="modal">
        <div class="bg-gray-800 rounded-xl p-6 max-w-md w-full mx-4">
            <h3 class="text-xl font-semibold mb-4">Konfirmasi Tambah</h3>
            <p class="text-gray-300 mb-6">Apakah Anda yakin ingin menambah manga ini?</p>
    ...
    // Event listener untuk input stok
    document.querySelector('input[name="stock"]').addEventListener('blur', function() {
        if (this.value === '') {
            this.value = '0';
        }
    });
